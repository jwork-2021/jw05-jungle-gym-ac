...
import server.game.creature.Archer;
import server.game.creature.Demon;
import server.game.creature.Goblin;
import server.game.creature.Monster;
import server.game.creature.Player;
import server.game.creature.Vampire;
import server.game.creature.Wizard;
import server.mainWindow.EchoNIOServer;
import server.map.MyMap;
...
public class World {
    ...
    public Player[] players=new Player[EchoNIOServer.PlayerNumber];
